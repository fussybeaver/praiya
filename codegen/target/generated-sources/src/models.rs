...
pub struct AnalyticsmetricsincidentsallFilters {
    ...
    #[serde(rename = "business_service_ids")]
    #[serde(skip_serializing_if="Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Body53 {
    #[serde(rename = "status_update_notification_rule")]
    #[serde(skip_serializing_if="Option::is_none")]
...
pub struct InlineResponse20036 {
    ...
    #[serde(rename = "relationships")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub relationships: Option<Vec<InlineResponse20036Relationships>>,

}
/// The reference to the service that is dependent on the technical service.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20036DependentService {
    #[serde(rename = "id")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub id: Option<String>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20036Relationships {
    #[serde(rename = "supporting_service")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub supporting_service: Option<InlineResponse20036SupportingService>,

    #[serde(rename = "dependent_service")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub dependent_service: Option<InlineResponse20036DependentService>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20036SupportingService {
    #[serde(rename = "id")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub id: Option<String>,
...
pub struct InlineResponse20037 {
    ...
    #[serde(rename = "relationships")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub relationships: Option<Vec<InlineResponse20037Relationships>>,

}
/// The reference to the service that is dependent on the business service.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20037DependentService {
    #[serde(rename = "id")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub id: Option<String>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20037Relationships {
    #[serde(rename = "supporting_service")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub supporting_service: Option<InlineResponse20037SupportingService>,

    #[serde(rename = "dependent_service")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub dependent_service: Option<InlineResponse20037DependentService>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20037SupportingService {
    #[serde(rename = "id")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub id: Option<String>,
...
pub struct InlineResponse20041 {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub members: Option<Vec<InlineResponse20041Members>>,

}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20041Members {
    #[serde(rename = "user")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub user: Option<UserReference>,
...
pub struct InlineResponse20046 {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub subscriptions: Option<Vec<InlineResponse20023>>,
...
pub struct InlineResponse20050 {
    #[serde(rename = "status_update_notification_rules")]
    #[serde(skip_serializing_if="Option::is_none")]
...
pub struct ResponsePlay {
    ...
    #[serde(rename = "subscribers")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub subscribers: Option<Vec<WebhooksV1AssignedToUser>>,
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub responders: Option<Vec<WebhooksV1AssignedToUser>>,
