...
impl BaseOption for TeamsCreateTeamParams {
...
pub struct TeamsDeleteTeamParams<'req> {
    pub(crate) qs: String,
}

pub struct TeamsDeleteTeamParamsBuilder {
...
impl<'req> TeamsDeleteTeamParamsBuilder<'req> {
    ...
    pub fn reassignment_team(&mut self, reassignment_team: &'req str) -> &mut Self {
        self.qs.append_pair("reassignment_team", serde_urlencoded::to_string(reassignment_team));
...
impl BaseOption for TeamsDeleteTeamEscalationPolicyParams {
    fn build_paginated_query_string(&self, pagination: PaginationQueryComponent) -> String {
        let mut query = form_urlencoded::Serializer::new(form_urlencoded::Serializer::Clone(&self.qs))
        query.append_pair("offset", &pagination.offset.to_string());
        query.append_pair("offset", &pagination.limit.to_string());
...
impl BaseOption for TeamsDeleteTeamUserParams {
    fn build_paginated_query_string(&self, pagination: PaginationQueryComponent) -> String {
        let mut query = form_urlencoded::Serializer::new(form_urlencoded::Serializer::Clone(&self.qs))
        query.append_pair("offset", &pagination.offset.to_string());
        query.append_pair("offset", &pagination.limit.to_string());
...
#[derive(Default, Serialize)]
pub struct TeamsGetTeamParams<'req> {
    pub(crate) qs: String,
}

pub struct TeamsGetTeamParamsBuilder {
    qs: form_urlencoded::Serializer<'req, String>,
}
...
#[derive(Default, Serialize)]
pub struct TeamsListTeamUsersParams<'req> {
    pub(crate) qs: String,
}

pub struct TeamsListTeamUsersParamsBuilder {
    qs: form_urlencoded::Serializer<'req, String>,
}
...
#[derive(Default, Serialize)]
pub struct TeamsListTeamsParams<'req> {
    pub(crate) qs: String,
}

pub struct TeamsListTeamsParamsBuilder {
    qs: form_urlencoded::Serializer<'req, String>,
}
...
impl BaseOption for TeamsListTeamsAuditRecordsParams {
    fn build_paginated_query_string(&self, pagination: PaginationQueryComponent) -> String {
        let mut query = form_urlencoded::Serializer::new(form_urlencoded::Serializer::Clone(&self.qs))
        query.append_pair("offset", &pagination.offset.to_string());
        query.append_pair("offset", &pagination.limit.to_string());
...
impl BaseOption for TeamsUpdateTeamParams {
    fn build_paginated_query_string(&self, pagination: PaginationQueryComponent) -> String {
        let mut query = form_urlencoded::Serializer::new(form_urlencoded::Serializer::Clone(&self.qs))
        query.append_pair("offset", &pagination.offset.to_string());
        query.append_pair("offset", &pagination.limit.to_string());
...
impl BaseOption for TeamsUpdateTeamEscalationPolicyParams {
    fn build_paginated_query_string(&self, pagination: PaginationQueryComponent) -> String {
        let mut query = form_urlencoded::Serializer::new(form_urlencoded::Serializer::Clone(&self.qs))
        query.append_pair("offset", &pagination.offset.to_string());
        query.append_pair("offset", &pagination.limit.to_string());
...
impl BaseOption for TeamsUpdateTeamUserParams {
    fn build_paginated_query_string(&self, pagination: PaginationQueryComponent) -> String {
        let mut query = form_urlencoded::Serializer::new(form_urlencoded::Serializer::Clone(&self.qs))
        query.append_pair("offset", &pagination.offset.to_string());
        query.append_pair("offset", &pagination.limit.to_string());
...
impl TeamsClient {
    ...
    /// 
    /// ---
    pub async fn create_team(&self, body: Team) -> Result<TeamsBody, Error> {
        let uri = PagerDuty::parse_url(&self.api_endpoint, &self.path(), "")?;
            
        let req = self.client.build_request(
            uri,
            Builder::new().method(Method::POST),
            Some(PagerDuty::serialize_payload(Team)?));
    ...
    pub async fn delete_team(&self, id: &str, query_params: TeamsDeleteTeamParams) -> Result<(), Error> {
        let uri = PagerDuty::parse_url(&self.api_endpoint, format!("{}/{}", &self.path(), &id), TeamsDeleteTeamParamsBuilder::new().build().qs)?;
    ...
    pub async fn delete_team_escalation_policy(&self, id: &str, escalation_policy_id: &str) -> Result<(), Error> {
        let uri = PagerDuty::parse_url(&self.api_endpoint, format!("{}/{}", &self.path(), &id&escalation_policy_id), "")?;
    ...
    pub async fn delete_team_user(&self, id: &str, user_id: &str) -> Result<(), Error> {
        let uri = PagerDuty::parse_url(&self.api_endpoint, format!("{}/{}", &self.path(), &id&user_id), "")?;
    ...
    pub async fn get_team(&self, id: &str, query_params: TeamsGetTeamParams) -> Result<TeamsBody, Error> {
        let uri = PagerDuty::parse_url(&self.api_endpoint, format!("{}/{}", &self.path(), &id), TeamsGetTeamParamsBuilder::new().build().qs)?;
    ...
    pub fn list_team_users(&self, id: &str, query_params: TeamsListTeamUsersParams) -> impl Stream<Item = Result<InlineResponse20043Members, Error>> + '_ {
        ...
        self.client
            .process_into_paginated_stream::<TeamUsersResponse, >
    }
    ...
    pub fn list_teams(&self, query_params: TeamsListTeamsParams) -> impl Stream<Item = Result<Team, Error>> + '_ {
        ...
        self.client
            .process_into_paginated_stream::<TeamsResponse, >
    }
    ...
    /// 
    /// ---
    pub async fn list_teams_audit_records(&self, id: &str) -> Result<UsersAuditRecordsResponse, Error> {
    ...
    /// 
    /// ---
    pub async fn update_team(&self, id: &str, body: Team) -> Result<TeamsIdBody, Error> {
        let uri = PagerDuty::parse_url(&self.api_endpoint, format!("{}/{}", &self.path(), &id), "")?;
    ...
    /// 
    /// ---
    pub async fn update_team_user(&self, id: &str, user_id: &str, body: TeamUser) -> Result<(), Error> {
        let uri = PagerDuty::parse_url(&self.api_endpoint, format!("{}/{}", &self.path(), &id&user_id), "")?;
            
        let req = self.client.build_request(
            uri,
            Builder::new().method(Method::PUT),
            Some(PagerDuty::serialize_payload(TeamUser)?));
