...
impl SlackConnectionsClient {
    ...
    pub async fn create_connection(
        ...
        self.client
            .post_request::<_, _, CreateConnectionResponse>(url, body, PraiyaCustomHeaders::None)
            .await
    }
    ...
    /// 
    /// ---
    pub fn get_connections(&self, slack_team_id: &str) -> impl Stream<Item = Result<SlackConnection, Error>> + '_ {
    ...
    /// 
    /// ---
    pub async fn update_connection(&self, slack_team_id: &str, connection_id: &str, body: UpdateConnection) -> Result<SlackConnection, Error> {
        let url = Praiya::parse_url(&self.api_endpoint, &format!("./workspaces/{}/connections/{}", &slack_team_id, &connection_id), None)?;
